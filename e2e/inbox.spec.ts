...
test.describe("Inbox", () => {
  ...
  test("should display inbox with interactions", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="interaction-list"]'),
    ).toBeVisible();
  });
  ...
  test("should select and view interaction details", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="interaction-detail"]'),
    ).toBeVisible();
  });
...
test.describe("Interaction Detail", () => {
  ...
  test("should display bug report details", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="interaction-title"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="interaction-description"]'),
    ).toBeVisible();
  });
