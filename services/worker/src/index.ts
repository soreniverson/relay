...
async function start() {
  ...
  // Integration Workers
  workers.push(new Worker("linear-sync", linearSyncProcessor, workerOptions));

  workers.push(new Worker("slack-notify", slackNotifyProcessor, workerOptions));

  workers.push(new Worker("email-send", emailSendProcessor, workerOptions));
