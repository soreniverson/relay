...
async function main() {
  ...
  const bugInteraction = await prisma.interaction.create({
    data: {
      ...
      contentText:
        "Payment form crashes when I enter my card number. I've tried multiple cards but it keeps happening.",
      contentJson: {
    ...
    data: {
      ...
      console: [
        ...
        },
        {
          ...
          stack:
            "at CardForm.validate (card-form.js:42)\n  at HTMLInputElement.<anonymous> (card-form.js:15)",
        },
      ],
      network: [
        {
          method: "GET",
          url: "https://api.example.com/checkout/config",
          status: 200,
          duration: 150,
  ...
  await prisma.interaction.create({
    data: {
      ...
      sessionId: demoSession.id,
      contentText:
        "It would be great if you could add dark mode to the dashboard. My eyes hurt when working late at night.",
      contentJson: {
    ...
    data: [
      {
        ...
        contentJson: {
          ...
          description:
            "After the latest update, none of our team data is showing up. All dashboards are blank.",
        },
      ...
      },
      {
        ...
        contentJson: {
          ...
          description:
            "On iPhone, the login button sometimes does not respond to taps. Have to tap multiple times.",
        },
        tags: ["mobile", "auth"],
      ...
      },
      {
        ...
        contentJson: {
          ...
          description:
            "Hi, I need to export all my project data for a compliance audit. Where can I find the export feature?",
        },
        tags: ["support", "export"],
      ...
      },
      {
        ...
        contentJson: {
          ...
          score: 9,
          feedback:
            "Great product overall. Would be perfect with better mobile support.",
        },
        tags: ["nps", "promoter"],
      ...
      },
      {
        ...
        contentJson: {
          ...
          description:
            "Just wanted to say the new dashboard looks amazing. Much cleaner and easier to navigate.",
        },
      ...
      },
      {
        ...
        contentJson: {
          ...
          description:
            "We are trying to configure SAML SSO with Okta but getting an error. Can someone help?",
        },
  ...
  const feedbackItem1 = await prisma.feedbackItem.create({
    data: {
      ...
      description:
        "Add a dark mode theme option for users who prefer working in low-light environments.",
      status: "planned",
      category: "ui",
      voteCount: 47,
    },
  ...
  const feedbackItem2 = await prisma.feedbackItem.create({
    data: {
      ...
      title: "Export to PDF",
      description:
        "Allow users to export reports and dashboards to PDF format.",
      status: "under_review",
      category: "feature",
      voteCount: 23,
    },
  ...
  await prisma.roadmapItem.create({
    data: {
      ...
      description:
        "Major mobile app update with offline support and performance improvements.",
      visibility: "public",
      status: "planned",
      sortOrder: 2,
  ...
  await prisma.roadmapItem.create({
    data: {
      ...
      description:
        "Next generation API with improved performance and new endpoints.",
      visibility: "private",
      status: "planned",
      sortOrder: 3,
    },
  ...
  await prisma.featureFlag.createMany({
    data: [
      ...
      {
        projectId: usWestProject.id,
        flag: "integration_github",
        enabled: false,
      },
      {
        projectId: usWestProject.id,
        flag: "integration_email",
        enabled: false,
      },
