          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => setTypeFilter(null)}>
                All
                {typeFilter === null && <span className="ml-auto text-foreground">✓</span>}
              </DropdownMenuItem>
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span className="text-xs text-muted-foreground/70">
                      {announcement.viewCount > 0
                        ? Math.round((announcement.clickCount / announcement.viewCount) * 100)
                        : 0}% CTR
                    </span>
                    {(announcement.startAt || announcement.endAt) && (
                      <>
                        <span className="text-muted-foreground/40">·</span>
                        <span className="text-xs text-muted-foreground/50">scheduled</span>
                      </>
                    )}
                  </div>
                </div>
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent className="sm:max-w-[400px]">
          ...
          <DialogFooter className="pt-4">
            ...
            <Button size="sm" onClick={handleCreate} disabled={!newAnnouncement.title.trim()}>
              Create
            </Button>
          </DialogFooter>
        </DialogContent>
